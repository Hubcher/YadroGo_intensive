...
func (c *wordsClient) Ping(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
...
func (UnimplementedWordsServer) Ping(context.Context, *empty.Empty) (*empty.Empty, error) {
...
func _Words_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WordsServer).Ping(ctx, req.(*empty.Empty))
	}
